...
<div className='flex'>
  <p>Phone:</p>
  <Link href="03302354356" aria-label='My Phone Number'
   title="nmbr"  className='transition-colors duration-300 text-pink-600 text-secondary hover:text-violet-400'>03302354356</Link>
   <br />
</div>

<div className='flex'>
  <p>Email:</p>
  <Link href="Email" aria-label='My Email'
   title="mail"  className='transition-colors duration-300 text-pink-600 text-secondary hover:text-violet-400'>faqehanoor@gmail.com</Link>
   <br />
</div>

<div className='flex'>
  <p>LinkedIn:</p>
  <Link href="https://www.linkedin.com/in/faqeha-noor-2b5a4a254/" aria-label='LinkedIn'
   title="in"  className='transition-colors duration-300 text-pink-600 text-secondary hover:text-violet-400'>Faqeha Noor</Link>
   <br />
</div>
...
<div className="mb-9 flex justify-center">
  ...
  <Link 
    ...
    className="icons mx-0.5 lg:mx-5 sm:mx-5 text-neutral-200 dark:text-neutral-200
               bg-gradient-to-r from-indigo-500 via-pink-600 to-pink-500 rounded-full p-3
